...
public class Game extends Canvas {
    	...
    	public Game() {
    		...
    		JFrame container = new JFrame("Space Invaders Edit By Eric :D");
    	...
    	private void initEntities() {
              ...
              ship = new ShipEntity(this, "sprites/ship2.jpg", 10, 950);
              entities.add(ship);
